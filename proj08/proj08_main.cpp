...
int main(){
  ...
  // 31.55 14.99
  pair<double,double> pr = mark.high_low_year(2009, "DIS");
  ...
  */
  Market mrkt("dow.txt");
Player p1(1000);
p1.buy(mrkt,"WMT",20101231,10);
p1.buy(mrkt,"IBM",20101231, 2);
string s = p1.to_str();
cout << s;
string ans = "199.80,IBM:2,WMT:10";
//ASSERT_EQ(s,ans);
}
